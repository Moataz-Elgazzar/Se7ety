    ...
    routes: [
      ...
      GoRoute(
        ...
        builder: (context, state) => BlocProvider(
          create: (BuildContext context) => PatientHomeCubit()..filterBySpecialization((state.extra as SpecializationCardModel).name),
          child: SpecializationDocrorScreen(model: state.extra as SpecializationCardModel),
        ),
      ),
      GoRoute(path: doctorProfile, builder: (context, state) => DoctorProfileScreen(doctorModel: state.extra as DoctorModel,)),
      GoRoute(
        path: doctorSearch,
        builder: (context, state) => DoctorSearchScreen(searchKey: state.extra as String),
      ),
    ],
  );
}
